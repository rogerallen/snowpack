...
const SnowpackChart: React.FC = () => {
  ...
  if (loading) return <div className="h-96 flex items-center justify-center text-gray-500">Loading Snow Data...</div>;
    ...
    <div className="w-full bg-white p-6 rounded-xl shadow-sm border border-gray-200">
      <div className="mb-6 border-b border-gray-100 pb-4">
        ...
        <div className="flex items-baseline gap-2 mt-1">
          ...
          <span className="text-4xl font-bold text-oregon-blue">{currentSWE}"</span>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip 
              ...
              formatter={(value) =>
                typeof value === 'number' ? [`${value.toFixed(1)} inches`, 'Water Equivalent'] : null
              }
            />
